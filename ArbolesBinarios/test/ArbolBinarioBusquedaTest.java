...
public class ArbolBinarioBusquedaTest {
    ...
    public void debeEliminarElHijoIzquierdoDeLaRaiz() {
        Nodo primero = arbolBinario.insertar('e');
        Nodo segundo = arbolBinario.insertar('b');
        Nodo tercero = arbolBinario.insertar('a');
        Nodo cuarto = arbolBinario.insertar('c');
        Nodo quinto = arbolBinario.insertar('f');
        Nodo sexto = arbolBinario.insertar('h');
        Nodo septipo = arbolBinario.insertar('g');
        Nodo octavo = arbolBinario.insertar('w');

        boolean response = arbolBinario.eliminar('f');

        Assert.assertTrue("se esperaba que el nodo fuera eliminado", response);
        Assert.assertFalse("Se esperaba que el nodo con el carcater f no exista", arbolBinario.buscarNodo('f') != null);
        Assert.assertTrue("Se esperaba que el nodo con el caracter w exista", arbolBinario.buscarNodo('w') != null);
    }
}
