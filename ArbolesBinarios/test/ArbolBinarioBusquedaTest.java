...
public class ArbolBinarioBusquedaTest {
	...
	public void debeInsertar3NivelesEnElOrden5423DebeQuedarIzquierdoIzquierdoDerecho() {
		...
		Assert.assertEquals(
				"liga derecha de la liga izquierda de liga izquierda de la raiz sea el cuarto nodo insertado", 14,
				arbolBinario.retornarRaiz().getEstudiante().getCedula());

		Estudiante estudiante2 = new Estudiante("6", "juan", "calle", 20);
		arbolBinario.insertar(estudiante2);
		Assert.assertEquals(
				"liga derecha de la liga izquierda de liga izquierda de la raiz sea el cuarto nodo insertado", 6,
		...
		Assert.assertEquals(
				"liga derecha de la liga izquierda de liga izquierda de la raiz sea el cuarto nodo insertado", 24,
